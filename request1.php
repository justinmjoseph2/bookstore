...
?> </li>
    ...
    <section class="breadcrumb-section set-bg" data-setbg="./image/req.jpe">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        <h2 style="color: #7fad39;">Request A Book</h2>
    ...
    <footer>
                        ...
                        <div style="margin-bottom: 0%;"><p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
