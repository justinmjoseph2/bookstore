    ...
    <div class="row">
        <div class="col-lg-3">
            <div class="header__logo">
                <a href="admin.php"><img src="img/lo.png" style="height: 100px;width: 120px;" alt=""></a>								<ul class="header__menu__dropdown">
...
if (isset($_POST["submit"])) {
	$str = $_POST["search"];
	$sql = "SELECT * FROM `images` WHERE phone LIKE '%$str%' ORDER BY p_id DESC";
...
<table>  
				...
				<td><a href="del.php?p_id=<?php echo $row["p_id"]; ?>"><i class="fa fa-trash " aria-hidden="true"></i></td>
