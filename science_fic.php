<?php  
 ...
 $sql = "SELECT * FROM pdfs WHERE category LIKE '%science%' OR category LIKE '%science%fic%' ORDER BY ASC";  
...
$conn = mysqli_connect("localhost", "root", "", "manybook");  
	...
	$sql = "SELECT * FROM `pdfs` WHERE genre LIKE '%young%' OR genre LIKE '%adult%' ORDER BY title ASC";
    $run = mysqli_query($conn, $sql); 
	{
		?>
