<?php  
 $connect = mysqli_connect("localhost", "root", "", "manybook");  
 $sql = "SELECT * FROM pdfs WHERE category LIKE '%romance%' OR category LIKE '%Romance%' ORDER BY ASC";  
...
$conn = mysqli_connect("localhost", "root", "", "manybook");  
	...
	$sql = "SELECT * FROM `pdfs` WHERE genre LIKE '%horror%'ORDER BY title ASC";
    $run = mysqli_query($conn, $sql); 
	{
		?>
                            ...
                            <div class="product__discount__slider owl-carousel">
                                    ...
                                    <div class="product__discount__item">
                                        <div class="product__discount__item__pic set-bg">
                                            ...
                                            <ul class="product__item__pic__hover">
                                                ...
                                                <li><a href="login.php"><i class="fa fa-book"></i></a></li>
                                            </ul>
                                        </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        ...
                                        <div class="product__discount__item__text">
                                            <h5><a href="">Action & Adventure</a></h5>
                                ...
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        ...
                                        <div class="product__discount__item__text">
                                            <h5><a href="login.php">Mistery & Thriller</a></h5>
                                            <div class="product__item__price">   <span>   </span></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        ...
                                        <div class="product__discount__item__text">
                                            <h5><a href="login.php">Biographys & History</a></h5>
                                            <div class="product__item__price">   <span>   </span></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        ...
                                        <div class="product__discount__item__text">
                                            <h5><a href="login.php">Childrens</a></h5>
                                            <div class="product__item__price">   <span>   </span></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        ...
                                        <div class="product__discount__item__text">
                                            <h5><a href="login.php">Young Adults</a></h5>
                                            <div class="product__item__price">    <span>   </span></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        ...
                                        <div class="product__discount__item__text">
                                            <h5><a href="login.php">Fantasy</a></h5>
                                            <div class="product__item__price">    <span>   </span></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        ...
                                        <div class="product__discount__item__text">
                                            <h5><a href="login.php">Historical Fiction</a></h5>
                                            <div class="product__item__price">    <span>   </span></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        ...
                                        <div class="product__discount__item__text">
                                            <h5><a href="login.php">Horror</a></h5>
                                            <div class="product__item__price">    <span>   </span></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        ...
                                        <div class="product__discount__item__text">
                                            <h5><a href="login.php">Non-Fiction</a></h5>
                                            <div class="product__item__price">    <span>   </span></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        ...
                                        <div class="product__discount__item__text">
                                            <h5><a href="login.php">Science Fiction</a></h5>
                                            <div class="product__item__price">    <span>   </span></div>
                                        </div>
                                    </div>
                                </div>
