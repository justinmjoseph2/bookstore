...
<div class="row" style="text-align: center;">
                        ...
                        while($result = mysqli_fetch_assoc($run))  
                           ...
                           <div class="column" style="padding-left: 50px;">
                                ...
                                <button type="submit" name ="know"  style=" background-color: red; width:200px; height:50px;color:white; font-weight:bolder">Know More >></button>
                                    ...
                                    <div class="product__discount__item">
										...
										<img src="img/categories/ic-3.png" width="100" height="280">
                                            <ul class="product__item__pic__hover">
                                                ...
                                                <li><a href=" his_fic.php"><i class="fa fa-book"></i></a></li>
                                            </ul>
                                        </div>
                                        <div class="product__discount__item__text">
